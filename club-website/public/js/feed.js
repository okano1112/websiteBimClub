document.addEventListener('DOMContentLoaded', async () => {
  ...
  const loginUrl = window.location.pathname.includes('/page/') ? 'login.html' : './page/login.html';
